...
const EVALUATE = {
  STUDENT: {
    ...
    ADD: '/server/api/practice/schools/:sid/courses/:cid/evaluate/st/user?debug=1',
  },
  COURSE: {
    ...
    ADD: '/server/api/practice/schools/:sid/courses/:cid/evaluate/sc/user?debug=1',
  },
  TEACHER: {
    ...
    ADD: '/server/api/practice/schools/:sid/courses/:cid/evaluate/ts/user?debug=1',
  },
};
