...
function formateDate (time){
  ...
  return date.getFullYear()+1970 +'-' + (date.getMonth()+1) +'-'+date.getDate() +' '+date.getHours() +':' +date.getMinutes() +':' +date.getSeconds();
 }
  ...
  renderData = () => {
    return this.props.data.map((item) => {
      return {
        ...
        update_time:formateDate(item.update_time),
        create_time:formateDate(item.create_time),
      }
    });
  }
