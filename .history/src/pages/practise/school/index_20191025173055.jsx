...
class SchoolView extends React.PureComponent {
  ...
  componentDidMount() {
    ...
    handleClick = (value) => {
      hashHistory.push({
          pathname: '/practise/school/student',
          query: {
              schoolId:value,
          },
      })
      ...
      dataIndex: 'option',
        ...
        render: (text, record) =>
            // this.state.dataSource.length >= 1 ? (
                ...
                {/* <a onClick={() => this.handleClick(record.schoolId)}> */}
                  <a onClick={() => this.props.history.push("/practise/school/${record.schoolId}/student")}>
                查看
                </a>
                <Link tp={{pathname:'/practise/school/${record.schoolId}/student',state:{schoolId:record.schoolId}}}>查看</Link>
                </span>
            // ) : null,
    }
    ];
