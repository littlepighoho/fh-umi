  ...
  componentDidMount() {
    ...
    handleCreate = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            ...
            if(values.name)
                data.schoolName = values.name;
            if(values.schoolDecs)
                data.schoolClass = values.class;
            this.props.form.resetFields();
            this.setState({
                visible1: false,
            });
          ...
          <Form layout="vertical">
            ...
            <Form.Item label="名字">
                    ...
                    {getFieldDecorator('decs', {
                        ...
                        <Input placeholder={this.state.editData.schoolDecs}/>
                      )}
                    </Form.Item>
          </Form>
        </Modal>
